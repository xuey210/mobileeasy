...
@Api(basePath = "/weatherstation", value = "用户API", description = "用户相关", produces = "application/json")
...
public class WeatherStantionController {
	...
	@Autowired
	public WeatherStantionController(UserService userService, UserCreateFormValidator userCreateFormValidator,
